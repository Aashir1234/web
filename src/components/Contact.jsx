...
{/* Right Side: Text Content */}
        <motion.div
          ...
          className="flex-[1] sm:flex-[0.5] bg-black-100 p-6 rounded-2xl text-white w-full h-auto sm:h-full"
        >
        ...
        <motion.div
        variants={slideIn("right", "tween", 0.2, 1)}
        className="flex-1 sm:flex-[0.5] bg-black-100 p-1 rounded-2xl w-full h-auto sm:h-full"
        >
